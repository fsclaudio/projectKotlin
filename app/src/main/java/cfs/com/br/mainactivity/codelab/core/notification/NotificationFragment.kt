package cfs.com.br.mainactivity.codelab.core.notification
...
import cfs.com.br.mainactivity.databinding.FragmentNotificationBinding
...
class NotificationFragment : Fragment(R.layout.fragment_notification) {
   ...
   // private val dynamicReceiver = DynamicReceiver()
    ...
    private fun updateNotification() {
        ...
        val androidImage = BitmapFactory.decodeResource(resources, R.drawable.ic_snake_act)
